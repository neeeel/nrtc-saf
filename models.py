...
class Project(models.Model):
    ...
    methodology = models.CharField("Survey Methodology",blank=True,null=True, max_length=256)
...
class NetworkInfo(models.Model):
    ...
    iFlow = models.IntegerField("IFlow",default=1)
    ...
    streetLights = models.IntegerField("Street Lights",blank=True,null=True)
    skewed = models.IntegerField("Skewed",blank=True,null=True)
    lessThan65 = models.IntegerField("Skewed",blank=True,null=True)
    affectedByRoadworks = models.IntegerField("Traffic affected by roadwork events?",blank=True,null=True)
    affectedByChangesToNetwork = models.IntegerField("Traffic affected by changes to road network/land use?",blank=True,null=True)
